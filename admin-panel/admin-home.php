<?php
    ...
    if(isset($_POST['approvalID'])){
        $mysqli->query("UPDATE product SET approval=1 WHERE product_id={$_POST['approvalID']}");
    }
    if(isset($_POST['denialID'])){
        $mysqli->query("DELETE FROM product WHERE product_id={$_POST['denialID']}");
    }
?>
<html lang="en">
...
<head>
    ...
    <title>Admin Home Pending Ads</title>
...
<body>
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                $retrieve_data = $mysqli->query("SELECT product_id,name,price,sell_or_rent,description,first_name,last_name,city,state,id,PRODUCT.image FROM product inner join account on product.seller_id=account.id WHERE APPROVAL=0");
                ...
                <td><b><?php echo $account['product_id']; ?></b></td>
                    ...
                    <td>
                        <button class="approve" value="<?php echo $account['product_id'];?>">Approve</button> <br><br> 
                        <button class="deny" value="<?php echo $account['product_id'];?>">Delete</button>
                    </td>
                </tr>
                <?php
               }
